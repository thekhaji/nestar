...
export class BoardArticleService {
    constructor(
        @InjectModel('BoardArticle') private readonly boradArticleModel: Model<BoardArticle>,
    ...
    public async createBoardArticle(memberId: ObjectId, input: BoardArticleInput): Promise<BoardArticle>{
        ...
        try {
            const result = await this.boradArticleModel.create(input);
    ...
    public async getBoardArticle(memberId: ObjectId, articleId: ObjectId): Promise<BoardArticle>{
        ...
        const tartgetBoardArticle: BoardArticle = await this.boradArticleModel.findOne(search).lean().exec();
        
        if(!tartgetBoardArticle) throw new InternalServerErrorException(Message.NO_DATA_FOUND);
    ...
    public async likeTargetBoardArticle(memberId: ObjectId, likeRefId: ObjectId): Promise<BoardArticle>{
        const target: BoardArticle = await this.boradArticleModel.findOne({_id: likeRefId, articleStatus: BoardArticleStatus.ACTIVE}).exec();
    ...
    public async boardArticleStatsEditor(input: StatisticModifier): Promise<BoardArticle>{
        ...
        return await this.boradArticleModel.findByIdAndUpdate(
            _id,
